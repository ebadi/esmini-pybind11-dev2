...
void bind_unknown_unknown(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// RM_CreatePosition() file: line:114
	...
	// RM_GetNrOfPositions() file: line:120
	...
	// RM_DeletePosition(int) file: line:127
	...
	// RM_CopyPosition(int) file: line:134
	...
	// RM_SetAlignMode(int, int) file: line:145
	...
	// RM_SetAlignModeH(int, int) file: line:156
	...
	// RM_SetAlignModeP(int, int) file: line:167
	...
	// RM_SetAlignModeR(int, int) file: line:178
	...
	// RM_SetAlignModeZ(int, int) file: line:189
	...
	// RM_SetLockOnLane(int, bool) file: line:196
	...
	// RM_GetNumberOfRoads() file: line:202
	...
	// RM_GetIdOfRoadFromIndex(int) file: line:209
	...
	// RM_GetRoadLength(int) file: line:216
	...
	// RM_GetRoadNumberOfLanes(int, float) file: line:224
	...
	// RM_GetLaneIdByIndex(int, int, float) file: line:233
	...
	// RM_SetLanePosition(int, int, int, float, float, bool) file: line:245
	...
	// RM_SetS(int, float) file: line:253
	...
	// RM_SetWorldPosition(int, float, float, float, float, float, float) file: line:266
	...
	// RM_SetWorldXYHPosition(int, float, float, float) file: line:276
	...
	// RM_SetWorldXYZHPosition(int, float, float, float, float) file: line:287
	...
	// RM_PositionMoveForward(int, float, float) file: line:296
	...
	// RM_GetSpeedLimit(int) file: line:311
	...
	// RM_GetNumberOfRoadSigns(int) file: line:349
	...
	// RM_GetNumberOfRoadSignValidityRecords(int, int) file: line:366
...
// Source list file: /home/wave/repositories/esmini-pybind11-dev/esmini/EnvironmentSimulator/src/esminirmlib/pyesminirmlib.sources
// pyesminirmlib.cpp
// unknown/unknown.cpp

// Modules list file: /home/wave/repositories/esmini-pybind11-dev/esmini/EnvironmentSimulator/src/esminirmlib/pyesminirmlib.modules
// 
